<?php
namespace CagLedenbladenBlock\Site\BlockLayout;
 ...
 */
class CagLedenbladenBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'CAG Ledenbladen Form'; // @translate
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      parse_str("resource_template_id[]=37", $query);
      
      $titels = $view->references()->list('dcterms:alternative',$query,array());
      $titels = $titels['o:references'];

      return $view->partial('common/block-layout/cag-ledenbladen-block', [
        'block' => $block,
        'titels' => $titels
      ]);
