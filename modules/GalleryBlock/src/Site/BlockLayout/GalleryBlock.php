<?php
namespace GalleryBlock\Site\BlockLayout;
 ...
 */
class GalleryBlock extends AbstractBlockLayout
{
    /**
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/gallery-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/gallery-block', [
        'block' => $block,
