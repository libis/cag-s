<?php
namespace CagSearchBlock\Site\BlockLayout;
 ...
 */
class CagSearchBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'CAG Search Form'; // @translate
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/cag-search-block', [
        'item' => $item,
        'block' => $block,
