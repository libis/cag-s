<?php
namespace OdisBlock\Site\BlockLayout;
 ...
 */
class OdisBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'CAG - Odis Search Form'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/odis-block-form', [
            'block' => $block,
        ]);
    }
    ...
    {
      return $view->partial('common/block-layout/odis-block', [
        'block' => $block,
      ]);
    }
}
