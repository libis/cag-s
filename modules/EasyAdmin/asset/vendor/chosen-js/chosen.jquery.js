  ...
  AbstractChosen = (function() {
    class AbstractChosen {
      ...
      winnow_results(options) {
        var endpos, escaped_query, exact_regex, exact_result, fix, highlight_regex, i, j, k, l, last_normalized_text, len, match_value, normalizedQuery, normalized_text, offset, option, prefix, query, ref, ref1, ref2, regex, results, results_group, search_match, startpos, substr_normalized_text, suffix, text;
        ...
        escaped_query = normalizedQuery.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&");
